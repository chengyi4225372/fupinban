...
class File extends LogicBase
{
    ...
    public function fileUpload($name = 'file')
    {
        ...
        $object = $object_info->validate(['ext'=>'jpg,png,gif,zip,rar,tar,gz,7z,doc,docx,txt,xml,xlsx,xls,mp4,avi,mp3,ogg,MP3,MP4,mp4'])->move(PATH_FILE);
    ...
    public function getFileUrl($id = 0)
    {
        ...
        $info = $this->modelFile->getInfo(['id' => $id], 'path');
